namespace Sporacid.Simplets.Webapp.Tools.Collections.Dictionary
{
    ...
    public class LinkedDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        {
            return this.linkedList.Remove(item) && this.dictionary.Remove(item.Key);
        }
        ...
        /// <summary>
        /// Determines whether the <see cref="T:System.Collections.Generic.IDictionary`2" /> contains an element with the specified
        /// key.
        /// </summary>
        /// <returns>
        ...
        {
            this.linkedList.AddLast(new KeyValuePair<TKey, TValue>(key, value));
        ...
        public bool Remove(TKey key)
        {
            ...
            return removed && this.dictionary.Remove(key);
        }
