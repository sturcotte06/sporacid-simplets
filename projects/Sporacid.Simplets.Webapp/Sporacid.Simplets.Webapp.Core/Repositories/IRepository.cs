namespace Sporacid.Simplets.Webapp.Core.Repositories
{
    ...
    public interface IRepository<in TEntityId, TEntity> where TEntity : IHasId<TEntityId>
    {
        ...
        IQueryable<TEntity> GetAll([Required] Expression<Func<TEntity, bool>> whereClause);
        ...
        bool Has([Required] TEntity entity);
        ...
        /// <param name="whereClause">Predicate to use as a where clause.</param>
        /// <returns>Whether the entity exists or not</returns>
        bool Has([Required] Expression<Func<TEntity, bool>> whereClause);
        ...
        TEntity GetUnique([Required] Expression<Func<TEntity, bool>> whereClause);

        /// <summary>
        /// Adds an entity to the system.
        /// </summary>
        /// <param name="entity">The entity.</param>
        void Add([Required] TEntity entity);

        /// <summary>
        /// Adds all entities to the system.
        /// </summary>
        /// <param name="entities">The entities.</param>
        void AddAll([Required] IEnumerable<TEntity> entities);
        ...
        /// </summary>
        /// <param name="entity">The entity.</param>
        void Delete([Required] TEntity entity);
        ...
        /// </summary>
        /// <param name="whereClause">Predicate to use as a where clause.</param>
        void DeleteAll([Required] Expression<Func<TEntity, bool>> whereClause);

        /// <summary>
        /// Updates an entity.
        /// </summary>
        /// <param name="entity">The entity.</param>
        void Update([Required] TEntity entity);

        /// <summary>
        /// Updates all entities
        /// </summary>
        /// <param name="entities">The entities.</param>
        void UpdateAll([Required] IEnumerable<TEntity> entities);
    }
}